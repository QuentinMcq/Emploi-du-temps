<template>
  <div>
    <div>
      <b-container>
        <b-button v-if="!created" variant="success" @click="create">
          Ajouter un créneau
        </b-button>
    ...
    <div>
      <h1>SEMAINE 1</h1>
      <table id="element-id-1" class="table table-striped table-bordered">
        ...
        <tbody>
          <tr class="year-cell">
            <td />
            <th class="year-color" colspan="6">
              {{ 'INFO 1' }}
            </th>
            <th class="year-color" colspan="8">
              {{ 'INFO 2' }}
            </th>
          ...
          <tr class="mainGroup-cell">
            <td />
            <th v-for="mainGroup in mainGroups" :key="mainGroup.id" colspan="2">
              {{ mainGroup }}
            </th>
          ...
          <tr v-for="(hour, index) in hours" :key="index">
            ...
            <td v-for="val in 89" :key="val.id" class="board" />
          </tr>
        </tbody>
      </table>
      ...
      <table id="element-id-2" class="table table-striped table-bordered">
        <thead class="thead-dark">
          <tr>
            <td />
        ...
        <tbody>
          ...
          <tr v-for="(hour, index) in hours" :key="index">
            ...
            <td v-for="val in 89" :id="id" :key="val.id" class="board" />
          </tr>
        </tbody>
      </table>
      ...
      <table id="element-id-3" class="table table-striped table-bordered">
        <thead class="thead-dark">
          <tr>
            <td />
...
export default {
  ...
  methods: {
    ...
    addCard(table, cours, matiere, salle, prof, row, cell, width, height) {
      ...
      switch (cours) {
        case 'TD':
          div.style.backgroundColor = '#fff68f';
          break;
        case 'TP':
          div.style.backgroundColor = '#f0d76f';
          break;
        case 'CM':
          div.style.backgroundColor = '#dbca86';
          break;
        case 'DS':
          div.style.backgroundColor = '#c9bf95';
          break;
        default:
          div.style.backgroundColor = '#ffb960';
      }
      ...
      if (matiere !== '') {
        ...
        spanMatiere.appendChild(
          document.createTextNode(data['matieres'][matiere]['nom'])
        );
      ...
      if (salle !== '') {
        ...
        spanSalle.appendChild(
          document.createTextNode(data['salles'][salle]['nom'])
        );
      ...
      if (prof !== '') {
        ...
        spanProf.appendChild(
          document.createTextNode(data['profs'][prof]['nom'])
        );
      ...
      let element = document.getElementById('element-id-' + table).rows[row]
        .cells[cell];
